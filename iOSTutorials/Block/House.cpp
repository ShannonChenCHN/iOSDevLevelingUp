...
struct __House__init_block_impl_0 {
  ...
  __House__init_block_impl_0(void *fp, struct __House__init_block_desc_0 *desc, int flags=0) {
...
static void __House__init_block_func_0(struct __House__init_block_impl_0 *__cself, Person *person) {
            ...
            ((void (*)(id, SEL, NSString *))(void *)objc_msgSend)((id)person, sel_registerName("setName:"), (NSString *)&__NSConstantStringImpl__var_folders_yc_v6mdtm514xbb7b98_1t63yb00000gn_T_House_8cad83_mi_0);
        }

static struct __House__init_block_desc_0 {
  size_t reserved;
  size_t Block_size;
} __House__init_block_desc_0_DATA = { 0, sizeof(struct __House__init_block_impl_0)};


// House 对象的 init 方法的实现
static instancetype _I_House_init(House * self, SEL _cmd) {
    ...
    if (self) {
        ...
        ((void (*)(id, SEL, void (*)(Person *)))(void *)objc_msgSend)((id)(*(Person **)((char *)self + OBJC_IVAR_$_House$_person)), sel_registerName("setCallback:"), ((void (*)(Person *))&__House__init_block_impl_0((void *)__House__init_block_func_0, &__House__init_block_desc_0_DATA)));
        
        // 简化模型
        // objc_msgSend(_person, sel_registerName("setCallback:"), (void (*)(Person *))&__House__init_block_impl_0());
        //  其中的参数 block(结构体指针)的构造函数中的参数实际上是这样的 __House__init_block_impl_0((void *)__House__init_block_func_0, &__House__init_block_desc_0_DATA)
        // 其中第一个参数是指向 block 实现函数的指针
